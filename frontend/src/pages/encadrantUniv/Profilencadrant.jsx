...
const FIELDS = ['nom', 'prenom', 'mail', 'tel', 'specialite', 'grade'];

export default function Profilencadrantuniv() {
  ...
  const handleSave = async () => {
    try {
      ...
      await api.encadrantsUniv.update(userId, body);
      ...
      <div className="ml-24 p-6 md:p-8" style={{ background: 'var(--bg-color)', minHeight: '100vh' }}>
        <div className="max-w-3xl mx-auto">
          <ProfileHeader
            ...
            subtitle={data.mail}
            chip={data.specialite || t('roles.univSupervisor', 'Encadrant universitaire')}
            actions={!edit
